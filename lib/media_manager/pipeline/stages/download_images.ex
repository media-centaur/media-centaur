defmodule MediaManager.Pipeline.Stages.DownloadImages do
  @moduledoc """
  ...
  defp create_staging_dir do
    ...
    dir = Path.join([System.tmp_dir!(), "media_manager_staging", unique_id])
    File.mkdir_p!(dir)
    dir
  end

  defp image_downloader do
    Application.get_env(:media_manager, :staging_image_downloader, __MODULE__.HttpDownloader)
  end
