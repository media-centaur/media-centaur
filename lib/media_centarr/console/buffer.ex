defmodule MediaCentarr.Console.Buffer do
  ...
  persisted to `MediaCentarr.Settings` with a debounce to avoid excessive DB writes.

  All LiveViews and cross-context callers interact with the console through
  `MediaCentarr.Console` — never with this module directly.
  """
  use GenServer

  alias MediaCentarr.Console.{Entry, Filter}
  ...
  defp broadcast(message) do
    Phoenix.PubSub.broadcast(MediaCentarr.PubSub, Topics.console_logs(), message)
  end
