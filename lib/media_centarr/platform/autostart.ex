defmodule MediaCentarr.Platform.Autostart do
  ...
  * **macOS** — launchd (`Platform.Autostart.Launchd`, future
  ...
  3. **Tarball contract** — `tarball_required_paths/0`. The
     ...
     `share/systemd/media-centarr.service`; macOS will ship
     `share/launchd/com.media-centarr.app.plist`. Belongs to the
     supervisor, not the stager.

  ## Usage

      iex> MediaCentarr.Platform.Autostart.detected_unit()
      "media-centarr.service" | nil
