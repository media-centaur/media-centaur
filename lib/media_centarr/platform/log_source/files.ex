defmodule MediaCentarr.Platform.LogSource.Files do
  @moduledoc """
  macOS implementation of `MediaCentarr.Platform.LogSource`.
  ...
  the macOS-conventional location for application logs:
      ...
      ~/Library/Logs/Media Centarr/stdout.log
      ~/Library/Logs/Media Centarr/stderr.log
