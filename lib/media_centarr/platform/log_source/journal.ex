defmodule MediaCentarr.Platform.LogSource.Journal do
  @moduledoc """
  Linux implementation of `MediaCentarr.Platform.LogSource`.
  ...
  `MediaCentarr.Console.JournalSource`'s GenServer loop.
