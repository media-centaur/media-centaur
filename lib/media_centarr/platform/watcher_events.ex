defmodule MediaCentarr.Platform.WatcherEvents do
  ...
  vocabulary. Unknown atoms are dropped; duplicates collapse.
      ...
      iex> MediaCentarr.Platform.WatcherEvents.normalize([:created, :isfile])
      [:created]

      iex> MediaCentarr.Platform.WatcherEvents.normalize([:removed, :isfile])
      [:deleted]

      iex> MediaCentarr.Platform.WatcherEvents.normalize([:userdropped, :kerneldropped])
      [:scan_required]
  """
