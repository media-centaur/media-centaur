defmodule MediaCentarr.Pipeline.Stats do
  @moduledoc """
  ...
  def handle_telemetry([:media_centarr, :pipeline, :stage, :stop], measurements, metadata, config) do
    stage_stop(
      config.stats,
      metadata.stage,
  ...
  def handle_telemetry([:media_centarr, :pipeline, :queue_depth], measurements, metadata, config) do
