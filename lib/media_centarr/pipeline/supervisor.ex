defmodule MediaCentarr.Pipeline.Supervisor do
  @moduledoc """
  ...
  def start_pipeline do
    Supervisor.restart_child(__MODULE__, MediaCentarr.Pipeline.Discovery)
    Supervisor.restart_child(__MODULE__, MediaCentarr.Pipeline.Import)
  end

  @doc "Stops both pipeline Broadway processes (no-op if already stopped)."
  def stop_pipeline do
    Supervisor.terminate_child(__MODULE__, MediaCentarr.Pipeline.Import)
    Supervisor.terminate_child(__MODULE__, MediaCentarr.Pipeline.Discovery)
  end
  ...
  def pipeline_running? do
    ...
    Enum.all?(
      [MediaCentarr.Pipeline.Discovery, MediaCentarr.Pipeline.Import],
      fn id ->
