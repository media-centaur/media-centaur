defmodule MediaManagerWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :media_manager
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :media_manager
  end
