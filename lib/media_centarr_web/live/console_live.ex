defmodule MediaCentarrWeb.ConsoleLive do
  @moduledoc """
  Sticky dropdown console — always mounted via `MediaCentarrWeb.Layouts.console_mount/1`
  ...
  `MediaCentarrWeb.ConsoleLive.Shared`. Pure logic (filter mutation, visibility
  decisions, payload formatting) lives in `MediaCentarrWeb.ConsoleLive.Logic`.
