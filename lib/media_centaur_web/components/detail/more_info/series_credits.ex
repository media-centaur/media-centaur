defmodule MediaCentaurWeb.Components.Detail.MoreInfo.SeriesCredits do
  @moduledoc """
  ...
  *Created by* headline (mapped from TMDB `created_by`) plus a
  ...
  attr :entity, :map,
    required: true,
    doc:
      "series entity-map from `MediaCentaur.Library.Views.DetailItem.to_entity_map/1`. Reads `:crew` (list of `MediaCentaur.Library.Person` structs) for Creator filtering."
