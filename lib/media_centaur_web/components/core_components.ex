defmodule MediaCentaurWeb.CoreComponents do
  ...
  use Gettext, backend: MediaCentaurWeb.Gettext
  ...
  `MediaCentaur.Credo.Checks.RawBadgeClass` precommit check rejects the latter
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MediaCentaurWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MediaCentaurWeb.Gettext, "errors", msg, opts)
    end
  end
