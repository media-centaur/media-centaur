defmodule MediaCentaurWeb.SettingsLive.Danger do
  @moduledoc """
  The Danger Zone section of the Settings page — library maintenance actions
  (image repair, credits/subtitle refresh, extra-name rederive) and the
  clear-database control. `SettingsLive` delegates to `render/1` and hosts
  the action handlers.
  """
