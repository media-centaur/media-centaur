defmodule MediaCentaurWeb.StatusLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     assign(socket,
       loaded?: false,
       stage_concurrency: MediaCentaur.Pipeline.Stats.stage_concurrency(),
       image_pipeline_concurrency: MediaCentaur.Pipeline.Image.processor_concurrency(),
  ...
  defp activity_bundle(assigns) do
    %{
      ...
      stage_concurrency: assigns.stage_concurrency,
