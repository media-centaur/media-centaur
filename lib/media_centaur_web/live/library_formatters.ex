defmodule MediaCentaurWeb.LibraryFormatters do
  @moduledoc """
  ...
  duration is informational. Use `MediaCentaur.Format.format_seconds/1`
  ...
  Payload shape (built in `MediaCentaur.Playback.MpvSession`):
