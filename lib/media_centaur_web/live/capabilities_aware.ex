defmodule MediaCentaurWeb.Live.CapabilitiesAware do
  @moduledoc """
  Shared readiness-flag lifecycle for every LiveView in the app layout.

  `use MediaCentaurWeb.Live.CapabilitiesAware` (or registering this module
  ...
  defmacro __using__(_opts) do
    quote do
      on_mount {MediaCentaurWeb.Live.CapabilitiesAware, :default}
    end
  end
