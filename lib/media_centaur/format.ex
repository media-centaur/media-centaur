defmodule MediaCentaur.Format do
  @moduledoc """
  ...
  `MediaCentaurWeb.LibraryFormatters.format_human_duration/1`.
  """
  ...
  portion of `entity.date_published`.
      ...
      iex> MediaCentaur.Format.year(~D[2008-07-18])
      "2008"
      iex> MediaCentaur.Format.year(nil)
      nil
  """
  ...
  Zero-pads a non-negative integer to two digits.
      ...
      "03"
      iex> MediaCentaur.Format.pad2(42)
      "42"
  """
  ...
  are nil.
      ...
      iex> MediaCentaur.Format.episode_label(1, 3)
      "S01E03"
      iex> MediaCentaur.Format.episode_label(2, nil)
      "Season 2"
      iex> MediaCentaur.Format.episode_label(nil, nil)
      ""
  """
  ...
  (`StatusHelpers.format_bytes_iec/1`, `Detail.ManagePanel.format_file_size/1`).
  ...
  Formats a future `DateTime` as a human-readable countdown:
      ...
      iex> MediaCentaur.Format.relative_in(dt)
      "in 2h 15m"
