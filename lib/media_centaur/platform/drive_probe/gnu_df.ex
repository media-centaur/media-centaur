defmodule MediaCentaur.Platform.DriveProbe.GnuDf do
  @moduledoc """
  Linux implementation of `MediaCentaur.Platform.DriveProbe`.
  ...
  Lifted verbatim from the original `MediaCentaur.Storage.{available_bytes/1,
  ...
  """
  @spec parse_line(String.t()) :: {:ok, MediaCentaur.Platform.DriveProbe.drive_info()} | :error
