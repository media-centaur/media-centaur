defmodule MediaCentaur.Library.Progress.Events do
  @moduledoc """
  Typed payloads broadcast on the `library:progress` topic
  (Library Schema v2 Phase 3 Task D, ADR-041).

  `MediaCentaur.Library.Progress.Worker` is the sole publisher; every
  message flows through `broadcast/1` to keep the topic's contract
  enforceable. Consumers subscribe via `MediaCentaur.Topics.library_progress/0`
