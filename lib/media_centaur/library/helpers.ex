defmodule MediaCentaur.Library.Helpers do
  ...
  `MediaCentaur.Library.BroadcastCoalescerTest`.
  """
  def broadcast_entities_changed([]), do: :ok

  def broadcast_entities_changed(entity_ids) do
    if Application.get_env(:media_centaur, :coalesce_broadcasts?, true) do
      MediaCentaur.Library.BroadcastCoalescer.enqueue(entity_ids)
    else
