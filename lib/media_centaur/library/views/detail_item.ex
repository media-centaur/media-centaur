defmodule MediaCentaur.Library.Views.DetailItem do
  @moduledoc """
  ...
  contract of `MediaCentaur.Library.Views.detail/1` and
  `MediaCentaur.Library.Views.detail_by_container/2`.
  ...
  rather than embedded here:
    ...
    * **Cross-context overlays** — `ReleaseTracking` releases,
      `Playback.MpvSession` now-playing, and a title's rung are
