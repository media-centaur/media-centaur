defmodule MediaCentaur.Library.Views do
  @moduledoc """
  ...
  alias MediaCentaur.Library.Views.Detail
  ...
  alias MediaCentaur.Library.Views.Search
  ...
  `MediaCentaur.Library.Views.Detail`). Per-row reads bypass the
