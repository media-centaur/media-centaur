defmodule MediaCentaur.Console.View do
  @moduledoc """
  ...
  """
  @spec chip_state_class(MediaCentaur.Console.Filter.t(), atom()) :: String.t()
  ...
  otherwise returns `""`.
  """
  @spec level_button_class(MediaCentaur.Console.Filter.t(), atom()) :: String.t()
