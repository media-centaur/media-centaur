defmodule MediaCentaur.Downloads.HealthHistory do
  @moduledoc """
  Per-poll bookkeeping for the throughput history map that
  `MediaCentaur.Downloads.Health.classify/3` consumes.

  Pure module — no GenServer, no IO. Lives between
  `MediaCentaur.Downloads.QueueMonitor` (which holds the map in its
