defmodule MediaCentaur.Cache do
  ...
  (`MediaCentaur.Cache.Worker`) that subscribes to the topics feeding
  ...
  See `MediaCentaur.Topics` for the canonical taxonomy.
  ...
  Two steps:
    ...
    2. Register `{MediaCentaur.Cache.Worker, context: MyContext}`
  ...
  See `MediaCentaur.Library.Views.Detail` for the canonical
