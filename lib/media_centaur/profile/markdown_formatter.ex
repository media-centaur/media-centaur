defmodule MediaCentaur.Profile.MarkdownFormatter do
  @moduledoc """
  Renders a `MediaCentaur.Profile.RunData` to markdown.

  This is the human-readable counterpart of
  `MediaCentaur.Profile.JSONFormatter`. Both consume the same
