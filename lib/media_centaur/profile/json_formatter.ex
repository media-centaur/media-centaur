defmodule MediaCentaur.Profile.JSONFormatter do
  @moduledoc """
  Encodes a `MediaCentaur.Profile.RunData` to canonical JSON.

  This is the machine-readable counterpart of
  `MediaCentaur.Profile.MarkdownFormatter`. The shape is stable:
  ...
  alias MediaCentaur.Profile.RunData
  ...
  defp deserialise_deltas(deltas) do
    ...
    # first `:delta_abs` key.
    Code.ensure_loaded(MediaCentaur.Profile.Diff)
