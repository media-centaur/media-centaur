if Mix.env() in [:dev, :test] do
  defmodule MediaCentaur.Profile.Bench do
    @moduledoc """
    Benchee runner for `MediaCentaur.Profile.Suite` implementations.
    ...
    `lib/media_centaur/profile/suites/` — no central registry.
    ...
    *setup hooks* that prepare the world (e.g. warm vs cold ETS
    ...
    alias MediaCentaur.Profile.Suite
    ...
    defp suite_module?(mod) do
      ...
      String.starts_with?(mod_str, "Elixir.MediaCentaur.Profile.Suites.") and
