defmodule MediaCentaur.Profile.Suite do
  @moduledoc """
  ...
  `MediaCentaur.Profile.Suites.*` and are auto-discovered at runtime
  by `MediaCentaur.Profile.Bench` — adding a new suite means
  ...
  ## Example
      ...
      defmodule MediaCentaur.Profile.Suites.ContinueWatchingSuite do
