defmodule MediaCentaur.Settings.Controls do
  # `top_level?` (as on `Settings.Config`): namespace-nested for cohesion,
  # but a top-level boundary so external contexts can dep it directly —
  # Boundary doesn't allow deps on sub-boundaries.
  use Boundary,
    top_level?: true,
  ...
  alias MediaCentaur.Settings.Controls.{Binding, Catalog, Store}
