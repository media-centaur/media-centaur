defmodule MediaCentaur.Settings.Preferences.LibraryCardInfo do
  @moduledoc """
  ...
  use MediaCentaur.Settings.Preferences.BooleanSetting, key: "library_show_card_info", default: true
end
