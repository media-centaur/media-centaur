defmodule MediaCentaur.Subtitles.Detector.Runner do
  @moduledoc """
  ...
  `Application.put_env(:media_centaur, :subtitles_runner, fn ... end)`
  ...
  def run(executable, args) do
    runner = Application.get_env(:media_centaur, :subtitles_runner, &default_runner/2)
