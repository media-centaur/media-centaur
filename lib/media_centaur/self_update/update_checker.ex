defmodule MediaCentaur.SelfUpdate.UpdateChecker do
  @moduledoc """
  ...
  ## Endpoint
      ...
      GET https://api.github.com/repos/media-centaur/media-centaur/releases/latest
  ...
  def compare(%{version: remote}, local) do
    case MediaCentaur.Version.compare_versions(remote, local) do
      :gt -> :update_available
      :eq -> :up_to_date
      :lt -> :ahead_of_release
      :error -> :error
