defmodule MediaCentaur.SelfUpdate.Updater do
  @moduledoc """
  ...
  Starts the Updater. Accepts injectable module dependencies:
    ...
    * `:downloader` — defaults to `MediaCentaur.SelfUpdate.Downloader`
    * `:stager` — defaults to `MediaCentaur.SelfUpdate.Stager`
    * `:handoff` — defaults to `MediaCentaur.SelfUpdate.Handoff`
    * `:staging_root` — where staging dirs are created; defaults to
      `~/.cache/media-centaur/upgrade-staging/`
