defmodule MediaCentaur.SelfUpdate.Stager do
  @moduledoc """
  Validates and extracts a Media Centaur release tarball into a staging
  ...
  defp default_required do
    @base_required ++ MediaCentaur.Platform.Autostart.tarball_required_paths()
  end
