defmodule MediaCentaur.SelfUpdate.Handoff do
  @moduledoc """
  Spawns the staged `bin/media-centaur-install` as a detached process that
  ...
  def spawn_detached(staged_root, opts \\ []) do
    ...
    installer = Path.join(staged_root, "bin/media-centaur-install")
    ...
    autostart_env =
      MediaCentaur.Platform.Autostart.handoff_env_vars()
