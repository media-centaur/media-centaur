defmodule MediaCentaur.Acquisition.Config do
  ...
  def download_client_type, do: MediaCentaur.Config.get(:download_client_type)

  @doc "Returns the configured download client URL, or nil."
  @spec download_client_url() :: String.t() | nil
  def download_client_url, do: MediaCentaur.Config.get(:download_client_url)

  @doc "Returns the configured download client username, or nil."
  @spec download_client_username() :: String.t() | nil
  def download_client_username, do: MediaCentaur.Config.get(:download_client_username)
end
