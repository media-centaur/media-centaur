defmodule MediaCentaur.Acquisition.Pursuits.Events.Define do
  @moduledoc """
  ...
  ## Usage
      ...
      defmodule MediaCentaur.Acquisition.Pursuits.Events.PursuitStarted do
  ...
  defmacro __using__(opts) do
    ...
    quote bind_quoted: [kind: kind, payload_keys: payload_keys, all_keys: all_keys] do
      @behaviour MediaCentaur.Acquisition.Pursuits.Events.EventBehaviour
