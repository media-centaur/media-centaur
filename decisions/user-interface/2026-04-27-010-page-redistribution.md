...
- UIDR-006 (Library zone architecture) — superseded for `/`. The zone concept lives on inside `/library` for type tabs (All / Movies / TV / etc.) but no longer for cross-mode switching.
