defmodule MediaCentaurWeb.LibraryLiveTest do
  ...
  describe "page artwork" do
    test "the browse page carries the scrim only — no backdrop, even with candidates",
         %{conn: conn} do
      ...
      assert has_element?(view, ".page-side-dim")
  ...
  describe "library card info toggle" do
    ...
    alias MediaCentaur.Settings.Preferences.LibraryCardInfo
  ...
  describe "card play button toggle" do
    alias MediaCentaur.Settings.Preferences.CardPlayButton
    alias MediaCentaur.Settings
    alias MediaCentaur.Topics
