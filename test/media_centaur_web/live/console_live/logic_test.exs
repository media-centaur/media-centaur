defmodule MediaCentaurWeb.ConsoleLive.LogicTest do
  ...
  describe "download_filename/1" do
    test "returns a deterministic filename for a given timestamp" do
      ...
      assert Logic.download_filename(timestamp) == "media-centaur-2026-04-05T14-23-45.log"
    end

    test "uses UTC hours regardless of system time" do
      timestamp = ~U[2026-01-01 00:00:00Z]
      assert Logic.download_filename(timestamp) == "media-centaur-2026-01-01T00-00-00.log"
    end
  end
