defmodule MediaCentaur.Credo.Checks.RawButtonClassTest do
  use Credo.Test.Case, async: true

  alias MediaCentaur.Credo.Checks.RawButtonClass
  ...
  describe "violations (positive cases)" do
    ...
    test "raw btn class in a function component is reported" do
      ~S'''
      defmodule MediaCentaurWeb.MyComponent do
        use Phoenix.Component
      ...
      '''
      |> to_source_file("lib/media_centaur_web/components/my_component.ex")
      |> run_check(RawButtonClass)
      |> assert_issue()
    end
