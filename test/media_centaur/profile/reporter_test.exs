defmodule MediaCentaur.Profile.ReporterTest do
  use ExUnit.Case, async: true

  alias MediaCentaur.Profile.{JSONFormatter, Reporter, RunData}

  @tmp_dir Path.join(System.tmp_dir!(), "media_centaur_profile_reporter_test")
  ...
  defp metadata do
    %{
      ...
      schedulers: 8,
      cpu_count: 16,
      database_path: "priv/profile/media-centaur.db"
    }
  end
  ...
  describe "write/2" do
    test "produces both markdown and JSON files with stable structure" do
      ...
      assert md_body =~ "# Media Centaur Profile Run"
