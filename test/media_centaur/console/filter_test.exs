defmodule MediaCentaur.Console.FilterTest do
  ...
  describe "solo_component/2" do
    test "only the given component is :show, all known others are :hide" do
      ...
      known_components = MediaCentaur.Console.View.known_components()
    ...
    test "solo on an unknown component writes it explicitly as :show" do
      ...
      for known_component <- MediaCentaur.Console.View.known_components() do
