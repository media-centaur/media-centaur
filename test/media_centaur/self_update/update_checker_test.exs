defmodule MediaCentaur.SelfUpdate.UpdateCheckerTest do
      ...
      Req.Test.stub(:github_releases, fn conn ->
        ...
        |> Plug.Conn.send_resp(
          ...
          JSON.encode!(%{
            ...
            "html_url" => "https://github.com/media-centaur/media-centaur/releases/tag/v0.5.0"
          })
        )
      end)
  ...
  describe "tag validation" do
      ...
      Req.Test.stub(:github_releases, fn conn ->
        ...
        |> Plug.Conn.send_resp(
          ...
          JSON.encode!(%{
            ...
            "published_at" => "2026-05-01T10:00:00Z",
            "html_url" => "https://github.com/media-centaur/media-centaur/releases/tag/v1.0.0"
          })
        )
      end)
      ...
      Req.Test.stub(:github_releases, fn conn ->
        ...
        |> Plug.Conn.send_resp(
          ...
          JSON.encode!(%{
            ...
            "published_at" => "2026-05-01T10:00:00Z",
            "html_url" => "https://github.com/media-centaur/media-centaur/releases/tag/v1.2.3-beta.4"
          })
        )
      end)
    ...
    test "replaces an html_url pointing at an unexpected host", %{client: client} do
      ...
      assert {:ok, release} = UpdateChecker.latest_release(client)
      assert release.html_url == "https://github.com/media-centaur/media-centaur/releases/tag/v1.0.0"
    end
