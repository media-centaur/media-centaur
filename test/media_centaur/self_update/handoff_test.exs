defmodule MediaCentaur.SelfUpdate.HandoffTest do
  use ExUnit.Case, async: true

  alias MediaCentaur.SelfUpdate.Handoff
  ...
  describe "spawn_detached/2" do
    test "invokes the spawn function with argv-form args (no shell interpolation into script)" do
      ...
      staged = "/home/user/.cache/media-centaur/upgrade-staging/0.7.1"
      ...
      assert installer == Path.join(staged, "bin/media-centaur-install")
