defmodule MediaCentaur.SelfUpdate.UpdaterTest do
  use MediaCentaur.DataCase, async: false

  alias MediaCentaur.SelfUpdate.{Updater, UpdateChecker}
  ...
  describe "apply_pending/1" do
    ...
    test "runs the full pipeline when a valid update is pending" do
      ...
      assert tarball_url ==
               "https://github.com/media-centaur/media-centaur/releases/download/v99.0.0/media-centaur-99.0.0-linux-x86_64.tar.gz"

      assert sha256_url ==
               "https://github.com/media-centaur/media-centaur/releases/download/v99.0.0/SHA256SUMS"
    ...
    test "allows a retry after a previous failure" do
      ...
      defmodule ToggleDownloader do
        def run(_tarball_url, _sha256_url, opts) do
          key = {MediaCentaur.SelfUpdate.UpdaterTest, :toggle_download_fails}
