defmodule MediaCentaur.ImagesTest do
  ...
  setup do
    ...
    original = Application.get_env(:media_centaur, :image_http_client)
    on_exit(fn -> Application.put_env(:media_centaur, :image_http_client, original) end)
    :ok
  end
  ...
  defp stub_http_success(body) do
    Application.put_env(:media_centaur, :image_http_client, __MODULE__.FakeClient)
