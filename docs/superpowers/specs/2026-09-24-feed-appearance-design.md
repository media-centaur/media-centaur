...
| **Act disc** | The act glyph's form on a poster: a disc of ink at .85 with a 1px white/18 ring at the poster's top right, inset 8px — 44px in the rail, 52 on the page — the love disc on `--color-love` with a white heart; two acts as two discs stacked downward 6px apart in mast order. The person card's form; the pennant stays the title surfaces'. |
